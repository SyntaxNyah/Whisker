...
- [ ] If you cannot use Cloudflare, I would recommend picking a VPS with dedicated DDoS protection. A proven example of a provider that works on AO is OVH. Their DDOS protection mitigates any AO user trying to crash your server. A majority of minecraft servers use them for a reason.
